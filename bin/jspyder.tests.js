...
$jscomp.iteratorPrototype = function $$jscomp$iteratorPrototype$($iterator_next$$) {
  $jscomp.initSymbolIterator();
  $iterator_next$$ = {next:$iterator_next$$};
  $iterator_next$$[$jscomp.global.Symbol.iterator] = function $$iterator_next$$$$jscomp$global$Symbol$iterator$() {
    return this;
  };
...
$jscomp.polyfill = function $$jscomp$polyfill$($property$$5_split_target$$, $impl_polyfill$$, $fromLang_obj$$, $i$$) {
  if ($impl_polyfill$$) {
    $fromLang_obj$$ = $jscomp.global;
    $property$$5_split_target$$ = $property$$5_split_target$$.split(".");
    for ($i$$ = 0;$i$$ < $property$$5_split_target$$.length - 1;$i$$++) {
      var $key$$ = $property$$5_split_target$$[$i$$];
      $key$$ in $fromLang_obj$$ || ($fromLang_obj$$[$key$$] = {});
      $fromLang_obj$$ = $fromLang_obj$$[$key$$];
    }
    $property$$5_split_target$$ = $property$$5_split_target$$[$property$$5_split_target$$.length - 1];
    $i$$ = $fromLang_obj$$[$property$$5_split_target$$];
    $impl_polyfill$$ = $impl_polyfill$$($i$$);
    $impl_polyfill$$ != $i$$ && null != $impl_polyfill$$ && $jscomp.defineProperty($fromLang_obj$$, $property$$5_split_target$$, {configurable:!0, writable:!0, value:$impl_polyfill$$});
  }
};
...
$jscomp.global.Object.defineProperties(TestObject$$module$TestObject.prototype, {prototype:{configurable:!0, enumerable:!0, get:function() {
...
$jscomp.global.Object.defineProperties(Browser$$module$Environment$Browser, {version:{configurable:!0, enumerable:!0, get:function() {
...
Objects$$module$Algorithms$Objects$Objects.MergeObjects = function $Objects$$module$Algorithms$Objects$Objects$MergeObjects$($base$$, $subs$$) {
  for (var $$jscomp$restParams$$ = [], $$jscomp$restIndex_i$$ = 1;$$jscomp$restIndex_i$$ < arguments.length;++$$jscomp$restIndex_i$$) {
    $$jscomp$restParams$$[$$jscomp$restIndex_i$$ - 1] = arguments[$$jscomp$restIndex_i$$];
  }
  for (var $$jscomp$restIndex_i$$ = 0, $li$$ = $$jscomp$restParams$$.length;$$jscomp$restIndex_i$$ < $li$$;++$$jscomp$restIndex_i$$) {
    var $sub$$ = $$jscomp$restParams$$[$$jscomp$restIndex_i$$];
    if ($sub$$) {
...
Objects$$module$Algorithms$Objects$Objects.GetProperty = function $Objects$$module$Algorithms$Objects$Objects$GetProperty$($object$$, $keyChain$$) {
  for (var $$jscomp$restParams$$ = [], $$jscomp$restIndex$$1_i$$ = 1;$$jscomp$restIndex$$1_i$$ < arguments.length;++$$jscomp$restIndex$$1_i$$) {
    $$jscomp$restParams$$[$$jscomp$restIndex$$1_i$$ - 1] = arguments[$$jscomp$restIndex$$1_i$$];
  }
  for (var $$jscomp$restIndex$$1_i$$ = 0, $li$$ = $$jscomp$restParams$$.length;$$jscomp$restIndex$$1_i$$ < $li$$;++$$jscomp$restIndex$$1_i$$) {
    var $key$$ = $$jscomp$restParams$$[$$jscomp$restIndex$$1_i$$];
    if ($object$$[$key$$]) {
      return $object$$[$key$$];
    }
  }
...
Numbers$$module$Algorithms$Numbers$Numbers.ToFloat = function $Numbers$$module$Algorithms$Numbers$Numbers$ToFloat$($value$$0$$) {
  if (USE_FLOAT_ARRAY$$module$Algorithms$Numbers$Numbers) {
    this.ToFloat = function $this$ToFloat$($frac_value$$) {
      for (var $sign$$ = 0 < $frac_value$$ ? 1 : -1, $exp$$ = 0, $base$$ = $frac_value$$ * $sign$$;2 <= $base$$ || 1 > $base$$;) {
        2 <= $base$$ && ($base$$ /= 2, $exp$$++), 1 > $base$$ && ($base$$ *= 2, $exp$$--);
      }
      $frac_value$$ = $frac_value$$ / Math.pow(2, $exp$$) - 1;
      $frac_value$$ = 1 + Math.round(8388608 * $frac_value$$) / 8388608;
      return +($sign$$ * $frac_value$$ * Math.pow(2, $exp$$)).toPrecision(8);
    };
  } else {
...
Numbers$$module$Algorithms$Numbers$Numbers.Magnitude = function $Numbers$$module$Algorithms$Numbers$Numbers$Magnitude$($num$$, $base$$4_width$$) {
  $base$$4_width$$ = void 0 === $base$$4_width$$ ? 10 : $base$$4_width$$;
  $num$$ = Numbers$$module$Algorithms$Numbers$Numbers.ToNumber($num$$) | 0;
  var $pow$$ = ((0 > $num$$ ? -$num$$ : $num$$) | 0).toString($base$$4_width$$).length - 1 || 1;
  $base$$4_width$$ = Math.pow($base$$4_width$$, $pow$$);
  return 0 > $num$$ ? Math.floor($num$$ / $base$$4_width$$) * $base$$4_width$$ : Math.ceil($num$$ / $base$$4_width$$) * $base$$4_width$$;
};
...
Arrays$$module$Algorithms$Arrays$Arrays.GetBestSortArrayObjectFunction = function $Arrays$$module$Algorithms$Arrays$Arrays$GetBestSortArrayObjectFunction$($ascending$$0$$, $fields$$0$$) {
  function $memoized$$($ascending$$, $fields$$) {
    ...
    switch(Browser$$module$Environment$Browser.name) {
      ...
      default:
        $__memo$$[$ascending$$] = function $$__memo$$$$ascending$$$($b_left$$, $right$$) {
          for (var $a_i$$ = 0;$b_left$$ && $right$$ && $a_i$$ < $fields$$.length;++$a_i$$) {
            $b_left$$ = $b_left$$[$fields$$[$a_i$$]], $right$$ = $right$$[$fields$$[$a_i$$]];
          }
          $a_i$$ = $ascending$$ ? $b_left$$ : $right$$;
          $b_left$$ = $ascending$$ ? $right$$ : $b_left$$;
          return $a_i$$ > $b_left$$ ? 1 : $a_i$$ < $b_left$$ ? -1 : 0;
        };
    }
    return $__memo$$[$ascending$$];
  }
...
Arrays$$module$Algorithms$Arrays$Arrays.WidePush = function $Arrays$$module$Algorithms$Arrays$Arrays$WidePush$($intoArray$$, $fromArray$$) {
  for (var $i$$ = 0, $end$$ = $fromArray$$.length;$i$$ < $end$$;$i$$ += MAX_CHUNK_SIZE$$module$Algorithms$Arrays$Arrays) {
    var $chunk$$ = Arrays$$module$Algorithms$Arrays$Arrays.Slice($fromArray$$, $i$$, Math.min($i$$ + MAX_CHUNK_SIZE$$module$Algorithms$Arrays$Arrays, $end$$));
...
Dates$$module$Algorithms$Dates$Dates.ToDate = function $Dates$$module$Algorithms$Dates$Dates$ToDate$($fromNumber_fromString_value$$, $defaultValue$$) {
  $defaultValue$$ = void 0 === $defaultValue$$ ? new Date : $defaultValue$$;
  if (Dates$$module$Algorithms$Dates$Dates.IsDate($fromNumber_fromString_value$$)) {
    return $fromNumber_fromString_value$$;
  }
  if ("string" === typeof $fromNumber_fromString_value$$) {
    if ($fromNumber_fromString_value$$ = Date.parse($fromNumber_fromString_value$$), Dates$$module$Algorithms$Dates$Dates.IsValid($fromNumber_fromString_value$$)) {
      return $fromNumber_fromString_value$$;
    }
  } else {
    if ("number" === typeof $fromNumber_fromString_value$$ && ($fromNumber_fromString_value$$ = new Date($fromNumber_fromString_value$$), Dates$$module$Algorithms$Dates$Dates.IsValid($fromNumber_fromString_value$$))) {
      return $fromNumber_fromString_value$$;
    }
  }
  return $defaultValue$$;
...
Functions$$module$Algorithms$Functions$Functions.BlankFunction = function $Functions$$module$Algorithms$Functions$Functions$BlankFunction$() {
};
...
JSObject$$module$JSObject.Mix = function $JSObject$$module$JSObject$Mix$($Subs$$) {
  for (var $$jscomp$restParams$$ = [], $$jscomp$restIndex$$7_i$$ = 0;$$jscomp$restIndex$$7_i$$ < arguments.length;++$$jscomp$restIndex$$7_i$$) {
    $$jscomp$restParams$$[$$jscomp$restIndex$$7_i$$ - 0] = arguments[$$jscomp$restIndex$$7_i$$];
  }
  for ($$jscomp$restIndex$$7_i$$ = 0;$$jscomp$restIndex$$7_i$$ < $$jscomp$restParams$$.length;++$$jscomp$restIndex$$7_i$$) {
    for (var $sub$$ = $$jscomp$restParams$$[$$jscomp$restIndex$$7_i$$], $properties$$ = Object.getOwnPropertyNames($sub$$.prototype), $j$$ = 0;$j$$ < $properties$$.length;++$j$$) {
...
$jscomp.global.Object.defineProperties(JSObject$$module$JSObject.prototype, {prototype:{configurable:!0, enumerable:!0, get:function() {
  return this.constructor.prototype;
}}});
...
var module$Algorithms$Looper$LooperController = {}, LoopController$$module$Algorithms$Looper$LooperController = function $LoopController$$module$Algorithms$Looper$LooperController$($source$$) {
  ...
  JSObject$$module$JSObject.call(this);
  this._break = !1;
  this._index = 0;
  this._source = $source$$;
...
$jscomp.global.Object.defineProperties(LoopController$$module$Algorithms$Looper$LooperController.prototype, {breaking:{configurable:!0, enumerable:!0, get:function() {
...
$jscomp.global.Object.defineProperties(ArrayLoopController$$module$Algorithms$Looper$LooperController.prototype, {index:{configurable:!0, enumerable:!0, set:function($index$$) {
...
Looper$$module$Algorithms$Looper$Looper.ArrayEach = function $Looper$$module$Algorithms$Looper$Looper$ArrayEach$($array$$, $loopFunction$$, $data$$) {
  for (var $$jscomp$restParams$$ = [], $$jscomp$restIndex$$10_controller$$ = 2;$$jscomp$restIndex$$10_controller$$ < arguments.length;++$$jscomp$restIndex$$10_controller$$) {
    $$jscomp$restParams$$[$$jscomp$restIndex$$10_controller$$ - 2] = arguments[$$jscomp$restIndex$$10_controller$$];
  }
  if ($array$$ && "object" === typeof $array$$) {
    for ($$jscomp$restIndex$$10_controller$$ = new ArrayLoopController$$module$Algorithms$Looper$LooperController($array$$), $$jscomp$restIndex$$10_controller$$.index = 0;$$jscomp$restIndex$$10_controller$$.index < $array$$.length && !$$jscomp$restIndex$$10_controller$$.breaking;++$$jscomp$restIndex$$10_controller$$.index) {
      Functions$$module$Algorithms$Functions$Functions.Use($$jscomp$restIndex$$10_controller$$, $loopFunction$$, [].concat([$array$$[$$jscomp$restIndex$$10_controller$$.index], $$jscomp$restIndex$$10_controller$$.index, $array$$], $jscomp.arrayFromIterable($$jscomp$restParams$$)));
    }
  }
};
Looper$$module$Algorithms$Looper$Looper.Iterate = function $Looper$$module$Algorithms$Looper$Looper$Iterate$($start$$, $end$$, $iterator$$, $data$$) {
  for (var $$jscomp$restParams$$ = [], $$jscomp$restIndex$$11_controller$$ = 3;$$jscomp$restIndex$$11_controller$$ < arguments.length;++$$jscomp$restIndex$$11_controller$$) {
    $$jscomp$restParams$$[$$jscomp$restIndex$$11_controller$$ - 3] = arguments[$$jscomp$restIndex$$11_controller$$];
  }
  $start$$ = Numbers$$module$Algorithms$Numbers$Numbers.ToNumber($start$$);
  $end$$ = Numbers$$module$Algorithms$Numbers$Numbers.ToNumber($end$$);
  for (var $$jscomp$restIndex$$11_controller$$ = new LoopController$$module$Algorithms$Looper$LooperController(null), $step$$ = $end$$ < $start$$ ? -1 : 1, $i$$ = $start$$;$i$$ !== $end$$ && !$$jscomp$restIndex$$11_controller$$.breaking;$i$$ += $step$$) {
    Functions$$module$Algorithms$Functions$Functions.Use($$jscomp$restIndex$$11_controller$$, $iterator$$, [].concat([$i$$], $jscomp.arrayFromIterable($$jscomp$restParams$$)));
  }
};
...
$jscomp.global.Object.defineProperties(KeyCodesInterface$$module$Algorithms$KeyCodes$KeyCodesInterface.prototype, {keycodes:{configurable:!0, enumerable:!0, get:function() {
}}});
...
JSAlgorithms$$module$Algorithms$JSAlgorithms.prototype.joinArray = function $JSAlgorithms$$module$Algorithms$JSAlgorithms$$joinArray$($arrayRef$$, $arraysFrom$$) {
  for (var $$jscomp$restParams$$ = [], $$jscomp$restIndex$$12_i$$ = 1;$$jscomp$restIndex$$12_i$$ < arguments.length;++$$jscomp$restIndex$$12_i$$) {
    $$jscomp$restParams$$[$$jscomp$restIndex$$12_i$$ - 1] = arguments[$$jscomp$restIndex$$12_i$$];
  }
  for ($$jscomp$restIndex$$12_i$$ = 0;$$jscomp$restIndex$$12_i$$ < $$jscomp$restParams$$.length;++$$jscomp$restIndex$$12_i$$) {
    Arrays$$module$Algorithms$Arrays$Arrays.WidePush($arrayRef$$, $$jscomp$restParams$$[$$jscomp$restIndex$$12_i$$]);
  }
  return $arrayRef$$;
};
...
$jscomp.global.Object.defineProperties(JSAlgorithms$$module$Algorithms$JSAlgorithms.prototype, {keycodes:{configurable:!0, enumerable:!0, get:function() {
...
var module$Registry$JSRegistry = {}, JSRegistry$$module$Registry$JSRegistry = function $JSRegistry$$module$Registry$JSRegistry$($cache$$) {
  $cache$$ = void 0 === $cache$$ ? Objects$$module$Algorithms$Objects$Objects.CreateBlankObject() : $cache$$;
  JSObject$$module$JSObject.call(this);
  this._cache = $cache$$;
};
...
JSRegistry$$module$Registry$JSRegistry.prototype.Fetch = function $JSRegistry$$module$Registry$JSRegistry$$Fetch$($key$$31_value$$, $callback$$) {
  $key$$31_value$$ = {key:$key$$31_value$$, value:this._cache[$key$$31_value$$]};
  Functions$$module$Algorithms$Functions$Functions.Run($callback$$, $key$$31_value$$);
  return $key$$31_value$$.value;
};
...
DOMElement$$module$Dom$DOMElement$DOMElement.AttachRegistry = function $DOMElement$$module$Dom$DOMElement$DOMElement$AttachRegistry$($element$$) {
  $element$$[REGISTRY_OBJECT$$module$Dom$DOMElement$DOMElement] || ($element$$[REGISTRY_OBJECT$$module$Dom$DOMElement$DOMElement] = (new JSRegistry$$module$Registry$JSRegistry).GetInterface());
};
DOMElement$$module$Dom$DOMElement$DOMElement.RegistryFetch = function $DOMElement$$module$Dom$DOMElement$DOMElement$RegistryFetch$($element$$, $key$$, $callback$$) {
  return $element$$[REGISTRY_OBJECT$$module$Dom$DOMElement$DOMElement].fetch($key$$, $callback$$);
};
DOMElement$$module$Dom$DOMElement$DOMElement.RegistryStash = function $DOMElement$$module$Dom$DOMElement$DOMElement$RegistryStash$($element$$, $key$$, $value$$) {
  return $element$$[REGISTRY_OBJECT$$module$Dom$DOMElement$DOMElement].stash($key$$, $value$$);
};
...
DOMElement$$module$Dom$DOMElement$DOMElement.SetDraggable = function $DOMElement$$module$Dom$DOMElement$DOMElement$SetDraggable$($element$$) {
};
...
var module$Dom$DOMEvent$DOMEvent = {}, REGISTRY_EVENT_LIST$$module$Dom$DOMEvent$DOMEvent = "__eventList", DISABLED_FLAG$$module$Dom$DOMEvent$DOMEvent = "__disabled__", EVENTS_BUBBLE$$module$Dom$DOMEvent$DOMEvent = !0, EVENTS_CANCEL$$module$Dom$DOMEvent$DOMEvent = !1, DOMEvent$$module$Dom$DOMEvent$DOMEvent = function $DOMEvent$$module$Dom$DOMEvent$DOMEvent$() {
};
DOMEvent$$module$Dom$DOMEvent$DOMEvent.AddEventHandler = function $DOMEvent$$module$Dom$DOMEvent$DOMEvent$AddEventHandler$($elementList$$, $eventNameList$$, $eventHandler$$) {
  for (var $li$$ = $elementList$$.length, $lj$$ = $eventNameList$$.length, $i$$ = 0;$i$$ < $li$$;++$i$$) {
    for (var $element$$ = $elementList$$[$i$$], $j$$ = 0;$j$$ < $lj$$;++$j$$) {
      var $eventHandlerList$$ = DOMEvent$$module$Dom$DOMEvent$DOMEvent.GetEventHandlerList($element$$, $eventNameList$$[$j$$]), $index$$ = $eventHandlerList$$.indexOf($eventHandler$$);
      -1 < $index$$ && $eventHandlerList$$.splice($index$$, 1);
      $eventHandlerList$$.push($eventHandler$$);
    }
  }
};
DOMEvent$$module$Dom$DOMEvent$DOMEvent.GetEventHandlerList = function $DOMEvent$$module$Dom$DOMEvent$DOMEvent$GetEventHandlerList$($element$$, $eventName$$) {
  var $eventDictionary_eventHandler$$ = DOMElement$$module$Dom$DOMElement$DOMElement.RegistryFetch($element$$, REGISTRY_EVENT_LIST$$module$Dom$DOMEvent$DOMEvent);
  $eventDictionary_eventHandler$$ || ($eventDictionary_eventHandler$$ = Objects$$module$Algorithms$Objects$Objects.CreateBlankObject(), DOMElement$$module$Dom$DOMElement$DOMElement.RegistryStash($element$$, REGISTRY_EVENT_LIST$$module$Dom$DOMEvent$DOMEvent, $eventDictionary_eventHandler$$));
  var $eventHandlerList$$ = $eventDictionary_eventHandler$$[$eventName$$];
  $eventHandlerList$$ || ($eventHandlerList$$ = $eventDictionary_eventHandler$$[$eventName$$] = [], $eventDictionary_eventHandler$$ = DOMEvent$$module$Dom$DOMEvent$DOMEvent.CreateEventHandler($eventHandlerList$$), $element$$.addEventListener($eventName$$, $eventDictionary_eventHandler$$));
  return $eventHandlerList$$;
};
DOMEvent$$module$Dom$DOMEvent$DOMEvent.CreateEventHandler = function $DOMEvent$$module$Dom$DOMEvent$DOMEvent$CreateEventHandler$($eventHandlerList$$) {
  function $eventHandler$$0$$($event$$) {
    for (var $i$$ = 0, $li$$ = $eventHandlerList$$.length;$i$$ < $li$$;++$i$$) {
      var $eventHandler$$ = $eventHandlerList$$[$i$$];
      if (!$eventHandler$$[DISABLED_FLAG$$module$Dom$DOMEvent$DOMEvent] && !1 === $eventHandler$$.apply(this, arguments)) {
        break;
      }
    }
  }
  return $eventHandlerList$$.eventHandler = $eventHandler$$0$$;
};
DOMEvent$$module$Dom$DOMEvent$DOMEvent.RemoveEventHandler = function $DOMEvent$$module$Dom$DOMEvent$DOMEvent$RemoveEventHandler$($elementList$$, $eventNameList$$, $removeEventHandlerList$$) {
  for (var $$jscomp$restParams$$ = [], $$jscomp$restIndex$$21_li$$ = 2;$$jscomp$restIndex$$21_li$$ < arguments.length;++$$jscomp$restIndex$$21_li$$) {
    $$jscomp$restParams$$[$$jscomp$restIndex$$21_li$$ - 2] = arguments[$$jscomp$restIndex$$21_li$$];
  }
  for (var $$jscomp$restIndex$$21_li$$ = $elementList$$.length, $lj$$ = $eventNameList$$.length, $disableLength$$ = $$jscomp$restParams$$.length, $i$$ = 0;$i$$ < $$jscomp$restIndex$$21_li$$;++$i$$) {
    for (var $element$$ = $elementList$$[$i$$], $j$$ = 0;$j$$ < $lj$$;++$j$$) {
      var $eventHandlerList$$ = DOMEvent$$module$Dom$DOMEvent$DOMEvent.GetEventHandlerList($element$$, $eventNameList$$[$j$$]);
      if ($disableLength$$) {
        for (var $k$$ = 0, $lk$$ = $eventHandlerList$$.length;$k$$ < $lk$$;++$k$$) {
          var $eventHandler$$ = $eventHandlerList$$[$k$$];
          -1 < $$jscomp$restParams$$.indexOf($eventHandler$$) && $eventHandlerList$$.splice($eventHandlerList$$.indexOf($eventHandler$$), 1);
        }
      } else {
...
DOMEvent$$module$Dom$DOMEvent$DOMEvent.TriggerEventHandler = function $DOMEvent$$module$Dom$DOMEvent$DOMEvent$TriggerEventHandler$($element$$, $event$$) {
  "string" === typeof $event$$ && ($event$$ = DOMEvent$$module$Dom$DOMEvent$DOMEvent.CreateEvent($element$$.ownerDocument, $event$$));
  $element$$.dispatchEvent($event$$);
};
DOMEvent$$module$Dom$DOMEvent$DOMEvent.CreateEvent = function $DOMEvent$$module$Dom$DOMEvent$DOMEvent$CreateEvent$($document$$0$$, $eventName$$0$$) {
  try {
    new Event($eventName$$0$$), DOMEvent$$module$Dom$DOMEvent$DOMEvent.CreateEvent = function $DOMEvent$$module$Dom$DOMEvent$DOMEvent$CreateEvent$($document$$, $eventName$$) {
      return new Event($eventName$$, {bubbles:EVENTS_BUBBLE$$module$Dom$DOMEvent$DOMEvent, cancelable:EVENTS_CANCEL$$module$Dom$DOMEvent$DOMEvent});
    };
  } catch ($e$$) {
    DOMEvent$$module$Dom$DOMEvent$DOMEvent.CreateEvent = function $DOMEvent$$module$Dom$DOMEvent$DOMEvent$CreateEvent$($document$$3_event$$, $eventName$$) {
      $document$$3_event$$ = $document$$3_event$$.createEvent("Event");
      $document$$3_event$$.initEvent($eventName$$, EVENTS_BUBBLE$$module$Dom$DOMEvent$DOMEvent, EVENTS_CANCEL$$module$Dom$DOMEvent$DOMEvent);
      return $document$$3_event$$;
    };
  }
  return DOMEvent$$module$Dom$DOMEvent$DOMEvent.CreateEvent($document$$0$$, $eventName$$0$$);
};
module$Dom$DOMEvent$DOMEvent.DOMEvent = DOMEvent$$module$Dom$DOMEvent$DOMEvent;
var module$Dom$DOMEvent$TestDOMEvent = {}, TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent = function $TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent$() {
  TestObject$$module$TestObject.call(this, "Dom/DOMEvent/DOMEvent");
  this.autoloadTests();
  this.startTests();
};
$jscomp.inherits(TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent, TestObject$$module$TestObject);
TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent.setLogger = TestObject$$module$TestObject.setLogger;
TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent.prototype.testGetEventHandlerList = function $TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent$$testGetEventHandlerList$() {
  var $element$$ = document.createElement("div");
  DOMElement$$module$Dom$DOMElement$DOMElement.AttachRegistry($element$$);
  var $eventHandlerList$$ = DOMEvent$$module$Dom$DOMEvent$DOMEvent.GetEventHandlerList($element$$, "click");
  module$Assert.Assert($eventHandlerList$$);
  module$Assert.Assert.Equal($eventHandlerList$$, DOMEvent$$module$Dom$DOMEvent$DOMEvent.GetEventHandlerList($element$$, "click"));
  module$Assert.Assert.NotEqual($eventHandlerList$$, DOMEvent$$module$Dom$DOMEvent$DOMEvent.GetEventHandlerList($element$$, "click-alt"));
};
TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent.prototype.testAddEventHandler = function $TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent$$testAddEventHandler$() {
  function $eventListener$$($event$$) {
    ++$triggeredCount$$;
  }
  var $triggeredCount$$ = 0, $manualCount$$ = 0, $dispatchEvent$$ = function $$dispatchEvent$$$($element$$, $eventName$$) {
    var $event$$ = document.createEvent("Event");
    $event$$.initEvent($eventName$$, !1, !1);
    $element$$.dispatchEvent($event$$);
    module$Assert.Assert.Equal(++$manualCount$$, $triggeredCount$$);
  }, $element1$$ = document.createElement("div"), $element2$$ = document.createElement("div");
  $element1$$.toString = function $$element1$$$toString$() {
    return "[Element 1]";
  };
  $element2$$.toString = function $$element2$$$toString$() {
    return "[Element 2]";
  };
  DOMElement$$module$Dom$DOMElement$DOMElement.AttachRegistry($element1$$);
  DOMElement$$module$Dom$DOMElement$DOMElement.AttachRegistry($element2$$);
  DOMEvent$$module$Dom$DOMEvent$DOMEvent.AddEventHandler([$element1$$, $element2$$], ["event1", "event2"], $eventListener$$);
...
TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent.prototype.testRemoveEventHandler = function $TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent$$testRemoveEventHandler$() {
  function $eventHandler$$($event$$) {
    ++$triggeredCount$$;
  }
  var $element1$$ = document.createElement("div"), $element2$$ = document.createElement("div");
  DOMElement$$module$Dom$DOMElement$DOMElement.AttachRegistry($element1$$);
  DOMElement$$module$Dom$DOMElement$DOMElement.AttachRegistry($element2$$);
  var $triggeredCount$$ = 0, $dispatchEvent$$ = function $$dispatchEvent$$$($element$$, $eventName$$) {
    var $event$$ = document.createEvent("Event");
    $event$$.initEvent($eventName$$, !1, !1);
    $element$$.dispatchEvent($event$$);
  };
  DOMEvent$$module$Dom$DOMEvent$DOMEvent.AddEventHandler([$element1$$, $element2$$], ["event"], $eventHandler$$);
  DOMEvent$$module$Dom$DOMEvent$DOMEvent.RemoveEventHandler([$element1$$], ["event"]);
  $dispatchEvent$$($element1$$, "event");
  module$Assert.Assert.Equal(0, $triggeredCount$$, "When generically removing event handlers, then all event handlers are removed");
  DOMEvent$$module$Dom$DOMEvent$DOMEvent.RemoveEventHandler([$element2$$], ["event"], function() {
  }, function() {
    return null;
  });
  $dispatchEvent$$($element2$$, "event");
  module$Assert.Assert.Equal(1, $triggeredCount$$, "Should not disable functions that are not explicitly defined in the list, if a list exists");
  DOMEvent$$module$Dom$DOMEvent$DOMEvent.RemoveEventHandler([$element2$$], ["event"], function() {
    return null;
  }, $eventHandler$$);
  $dispatchEvent$$($element2$$, "event");
  module$Assert.Assert.Equal(1, $triggeredCount$$, "Should be able to explicitly define event handlers to disable.");
};
TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent.prototype.testTriggerEventHandler = function $TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent$$testTriggerEventHandler$() {
  var $element$$ = document.createElement("div"), $triggeredCount$$ = 0;
  DOMElement$$module$Dom$DOMElement$DOMElement.AttachRegistry($element$$);
  DOMEvent$$module$Dom$DOMEvent$DOMEvent.AddEventHandler([$element$$], ["event"], function eventHandler($event$$) {
    ++$triggeredCount$$;
  });
  DOMEvent$$module$Dom$DOMEvent$DOMEvent.TriggerEventHandler($element$$, "event");
  module$Assert.Assert.Equal(1, $triggeredCount$$, "Expected event to trigger");
  DOMEvent$$module$Dom$DOMEvent$DOMEvent.TriggerEventHandler($element$$, "event-1");
  module$Assert.Assert.Equal(1, $triggeredCount$$, "Expected event to not trigger");
};
module$Dom$DOMEvent$TestDOMEvent.TestDOMEvent = TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent;
var module$Dom$DOMEvent$TestDOMEventInterface = {}, TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface = function $TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface$($jspyder$$) {
  this.jspyder = $jspyder$$;
  TestObject$$module$TestObject.call(this, "Dom/DOMElement/DOMElementInterface");
  this.autoloadTests();
  this.startTests();
};
$jscomp.inherits(TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface, TestObject$$module$TestObject);
TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface.setLogger = TestObject$$module$TestObject.setLogger;
TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface.prototype.testOn = function $TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface$$testOn$() {
  var $div$$ = document.createElement("div"), $triggered$$ = !1;
  this.jspyder.dom($div$$).on("click", function($event$$) {
    return $triggered$$ = !0;
  });
  var $event$$0$$ = document.createEvent("Event");
  $event$$0$$.initEvent("click", !1, !1);
  $div$$.dispatchEvent($event$$0$$);
  module$Assert.Assert($triggered$$, "Expected event to trigger");
};
TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface.prototype.testOff = function $TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface$$testOff$() {
  var $div$$ = document.createElement("div"), $dom$$1_event$$ = this.jspyder.dom($div$$), $triggered$$ = !1;
  $dom$$1_event$$.on("click", function($event$$) {
    return $triggered$$ = !0;
  });
  $dom$$1_event$$.off("click");
  $dom$$1_event$$ = document.createEvent("Event");
  $dom$$1_event$$.initEvent("click", !1, !1);
  $div$$.dispatchEvent($dom$$1_event$$);
  module$Assert.Assert(!$triggered$$, "Expected event to not trigger");
};
TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface.prototype.testTrigger = function $TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface$$testTrigger$() {
  var $div$$32_dom$$ = document.createElement("div"), $div$$32_dom$$ = this.jspyder.dom($div$$32_dom$$), $triggered$$ = !1;
  $div$$32_dom$$.on("click", function($event$$) {
    return $triggered$$ = !0;
  });
  $div$$32_dom$$.trigger("click");
  module$Assert.Assert($triggered$$, "Expected event to trigger");
};
module$Dom$DOMEvent$TestDOMEventInterface.TestDOMEventInterface = TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface;
...
var module$Dom$DOMTree$TestDOMTreeInterface = {}, TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface = function $TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface$($jspyder$$) {
  this.jspyder = $jspyder$$;
  TestObject$$module$TestObject.call(this, "Dom/DOMTree/DOMTreeInterface");
  this.autoloadTests();
  this.startTests();
};
$jscomp.inherits(TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface, TestObject$$module$TestObject);
TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface.setLogger = TestObject$$module$TestObject.setLogger;
TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface.prototype.testCreateDocumentFragment = function $TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface$$testCreateDocumentFragment$() {
  var $docFragment$$ = this.jspyder.dom("<div></div><div></div><div></div>").createDocumentFragment();
  module$Assert.Assert($docFragment$$);
  module$Assert.Assert.Equal(11, $docFragment$$.nodeType);
};
TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface.prototype.testAttach = function $TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface$$testAttach$() {
  var $parent$$ = document.createElement("div"), $child$$ = document.createElement("div");
  this.jspyder.dom($child$$).attach($parent$$);
  module$Assert.Assert.Equal($child$$, $parent$$.children[0]);
};
TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface.prototype.testAttachStart = function $TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface$$testAttachStart$() {
  var $parent$$ = document.createElement("div"), $child$$ = document.createElement("div");
  $parent$$.appendChild(document.createElement("div"));
  $parent$$.appendChild(document.createElement("div"));
  $parent$$.appendChild(document.createElement("div"));
...
TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface.prototype.testAttachBefore = function $TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface$$testAttachBefore$() {
  var $parent$$ = document.createElement("div"), $child1$$ = document.createElement("div"), $child2$$ = document.createElement("div");
  $parent$$.appendChild($child1$$);
  this.jspyder.dom($child2$$).attachBefore($child1$$);
  module$Assert.Assert.Equal($child2$$, $parent$$.children[0]);
};
TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface.prototype.testAttachAfter = function $TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface$$testAttachAfter$() {
  var $parent$$ = document.createElement("div"), $child1$$ = document.createElement("div"), $child2$$ = document.createElement("div");
  $parent$$.appendChild($child1$$);
  this.jspyder.dom($child2$$).attachAfter($child1$$);
  module$Assert.Assert.Equal($child2$$, $parent$$.children[1]);
};
TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface.prototype.testAppend = function $TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface$$testAppend$() {
  var $parent$$ = document.createElement("div"), $child$$ = document.createElement("div");
  $parent$$.appendChild(document.createElement("div"));
  $parent$$.appendChild(document.createElement("div"));
  $parent$$.appendChild(document.createElement("div"));
  ...
  module$Assert.Assert.Equal($child$$, $parent$$.lastChild);
};
TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface.prototype.testPrepend = function $TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface$$testPrepend$() {
  var $parent$$ = document.createElement("div"), $child$$ = document.createElement("div");
  $parent$$.appendChild(document.createElement("div"));
  $parent$$.appendChild(document.createElement("div"));
  $parent$$.appendChild(document.createElement("div"));
...
TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface.prototype.testAppendBefore = function $TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface$$testAppendBefore$() {
  var $parent$$ = document.createElement("div"), $child1$$ = document.createElement("div"), $child2$$ = document.createElement("div");
...
TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface.prototype.testFind = function $TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface$$testFind$() {
  var $div$$33_found$$ = document.createElement("div"), $find$$ = document.createElement("div");
  $find$$.className = "test-class";
  $div$$33_found$$.appendChild($find$$);
  $find$$.toString = function $$find$$$toString$() {
    return "[find div]";
  };
  $div$$33_found$$ = this.jspyder.dom($div$$33_found$$).find(".test-class").exportElement(0);
  module$Assert.Assert.Equal($find$$, $div$$33_found$$);
};
...
DOMPosition$$module$Dom$DOMPosition$DOMPosition.GetOffsetPosition = function $DOMPosition$$module$Dom$DOMPosition$DOMPosition$GetOffsetPosition$($element$$36_parent$$) {
  var $elementPosition$$ = DOMPosition$$module$Dom$DOMPosition$DOMPosition.GetPosition($element$$36_parent$$);
  if ("fixed" === getComputedStyle($element$$36_parent$$).position) {
    return $elementPosition$$;
  }
  for (;DOMElement$$module$Dom$DOMElement$DOMElement.IsElement($element$$36_parent$$.parentElement) && "static" === getComputedStyle($element$$36_parent$$.parentElement).position;) {
    $element$$36_parent$$ = $element$$36_parent$$.parentElement;
  }
  $element$$36_parent$$ = DOMPosition$$module$Dom$DOMPosition$DOMPosition.GetPosition($element$$36_parent$$);
  return {left:$elementPosition$$.left - $element$$36_parent$$.left, right:$elementPosition$$.right - $element$$36_parent$$.right, top:$elementPosition$$.top - $element$$36_parent$$.top, bottom:$elementPosition$$.bottom - $element$$36_parent$$.bottom};
};
...
var module$Dom$DOMEvent$DOMEventInterface = {}, DOMEventInterface$$module$Dom$DOMEvent$DOMEventInterface = function $DOMEventInterface$$module$Dom$DOMEvent$DOMEventInterface$() {
};
DOMEventInterface$$module$Dom$DOMEvent$DOMEventInterface.prototype.on = function $DOMEventInterface$$module$Dom$DOMEvent$DOMEventInterface$$on$($eventString$$, $handlerFunction$$) {
};
DOMEventInterface$$module$Dom$DOMEvent$DOMEventInterface.prototype.off = function $DOMEventInterface$$module$Dom$DOMEvent$DOMEventInterface$$off$($eventString$$, $handlerFunction$$) {
};
DOMEventInterface$$module$Dom$DOMEvent$DOMEventInterface.prototype.trigger = function $DOMEventInterface$$module$Dom$DOMEvent$DOMEventInterface$$trigger$($eventString$$) {
};
module$Dom$DOMEvent$DOMEventInterface.DOMEventInterface = DOMEventInterface$$module$Dom$DOMEvent$DOMEventInterface;
...
JSDom$$module$Dom$JSDom.prototype.getAttrs = function $JSDom$$module$Dom$JSDom$$getAttrs$($attributeObject$$, $callbackFunction$$) {
  ...
  this.each(function($element$$, $attributes$$1_index$$) {
    $attributes$$1_index$$ = $attributes$$1_index$$ ? {} : $attributeObject$$;
    for (var $i$$ = 0;$i$$ < $li$$;++$i$$) {
      var $key$$ = $attributeKeys$$[$i$$];
      $attributes$$1_index$$[$key$$] = DOMAttributes$$module$Dom$DOMAttributes$DOMAttributes.GetAttribute($element$$, $key$$);
    }
...
JSDom$$module$Dom$JSDom.prototype.exportAttr = function $JSDom$$module$Dom$JSDom$$exportAttr$($attributeName$$, $element$$49_index$$) {
  $element$$49_index$$ = this.exportElement(void 0 === $element$$49_index$$ ? 0 : $element$$49_index$$);
  return DOMAttributes$$module$Dom$DOMAttributes$DOMAttributes.GetAttribute($element$$49_index$$, $attributeName$$);
};
...
JSDom$$module$Dom$JSDom.prototype.getClasses = function $JSDom$$module$Dom$JSDom$$getClasses$($classObject$$, $callbackFunction$$) {
  ...
  this.each(function($element$$, $elementClasses_index$$) {
    $elementClasses_index$$ = $elementClasses_index$$ ? {} : $classObject$$;
    for (var $classCache$$ = DOMClasses$$module$Dom$DOMClasses$DOMClasses.GetClasses($element$$), $i$$ = 0;$i$$ < $li$$;++$i$$) {
      $elementClasses_index$$[$keys$$[$i$$]] = -1 !== $classCache$$.indexOf($keys$$[$i$$]);
    }
    $USE_CALLBACK$$ && new JSDom$$module$Dom$JSDom($element$$, $callbackFunction$$, [$elementClasses_index$$]);
  });
  return this;
};
...
JSDom$$module$Dom$JSDom.prototype.getPosition = function $JSDom$$module$Dom$JSDom$$getPosition$($callbackFunction$$) {
  ...
  this.each(function($element$$, $index$$) {
    $element$$ = DOMPosition$$module$Dom$DOMPosition$DOMPosition.GetPosition($element$$);
    $$jscomp$this$$.at($index$$).use($callbackFunction$$, [$element$$]);
  });
  return this;
};
JSDom$$module$Dom$JSDom.prototype.getOffsetPosition = function $JSDom$$module$Dom$JSDom$$getOffsetPosition$($callbackFunction$$) {
  var $$jscomp$this$$ = this;
  this.each(function($element$$54_position$$, $index$$) {
    $element$$54_position$$ = DOMPosition$$module$Dom$DOMPosition$DOMPosition.GetOffsetPosition($element$$54_position$$);
    $$jscomp$this$$.at($index$$).use($callbackFunction$$, [$element$$54_position$$]);
  });
  return this;
};
JSDom$$module$Dom$JSDom.prototype.on = function $JSDom$$module$Dom$JSDom$$on$($eventString$$, $handlerFunction$$) {
  "string" === typeof $eventString$$ && ($eventString$$ = $eventString$$.split(/\s+/));
  $eventString$$ = Arrays$$module$Algorithms$Arrays$Arrays.ToArray($eventString$$, []);
  DOMEvent$$module$Dom$DOMEvent$DOMEvent.AddEventHandler(this._element, $eventString$$, $handlerFunction$$);
  return this;
};
JSDom$$module$Dom$JSDom.prototype.off = function $JSDom$$module$Dom$JSDom$$off$($eventString$$, $handlerFunction$$) {
  ...
  "string" === typeof $eventString$$ && ($eventString$$ = $eventString$$.split(/\s+/));
  $eventString$$ = Arrays$$module$Algorithms$Arrays$Arrays.ToArray($eventString$$, []);
  DOMEvent$$module$Dom$DOMEvent$DOMEvent.RemoveEventHandler.apply(DOMEvent$$module$Dom$DOMEvent$DOMEvent, [].concat([this._element, $eventString$$], $jscomp.arrayFromIterable($$jscomp$restParams$$)));
  return this;
};
JSDom$$module$Dom$JSDom.prototype.trigger = function $JSDom$$module$Dom$JSDom$$trigger$($eventString$$) {
  ...
  this.each(function($element$$, $i$$53_index$$) {
    for ($i$$53_index$$ = 0;$i$$53_index$$ < $li$$;++$i$$53_index$$) {
      DOMEvent$$module$Dom$DOMEvent$DOMEvent.TriggerEventHandler($element$$, $eventString$$[$i$$53_index$$]);
    }
  });
  return this;
};
...
JSDom$$module$Dom$JSDom.prototype.attach = function $JSDom$$module$Dom$JSDom$$attach$($parent$$, $index$$) {
  ...
  $parent$$ = (new JSDom$$module$Dom$JSDom($parent$$)).exportElement($index$$);
  DOMTree$$module$Dom$DOMTree$DOMTree.AttachChildNode($parent$$, $documentFragment$$);
  return this;
};
JSDom$$module$Dom$JSDom.prototype.attachStart = function $JSDom$$module$Dom$JSDom$$attachStart$($parent$$29_parentDom$$, $index$$) {
  $index$$ = void 0 === $index$$ ? 0 : $index$$;
  var $documentFragment$$ = this.createDocumentFragment();
  $parent$$29_parentDom$$ = (new JSDom$$module$Dom$JSDom($parent$$29_parentDom$$)).exportElement($index$$);
  DOMTree$$module$Dom$DOMTree$DOMTree.AttachChildNodeAtStart($parent$$29_parentDom$$, $documentFragment$$);
  return this;
};
JSDom$$module$Dom$JSDom.prototype.attachBefore = function $JSDom$$module$Dom$JSDom$$attachBefore$($reference$$, $documentFragment$$3_index$$) {
  $documentFragment$$3_index$$ = void 0 === $documentFragment$$3_index$$ ? 0 : $documentFragment$$3_index$$;
  $reference$$ = (new JSDom$$module$Dom$JSDom($reference$$)).exportElement($documentFragment$$3_index$$);
  $documentFragment$$3_index$$ = this.createDocumentFragment();
  DOMTree$$module$Dom$DOMTree$DOMTree.InsertNodeBefore($reference$$, $documentFragment$$3_index$$);
  return this;
};
JSDom$$module$Dom$JSDom.prototype.attachAfter = function $JSDom$$module$Dom$JSDom$$attachAfter$($reference$$3_referenceDom$$, $documentFragment$$4_index$$) {
  $documentFragment$$4_index$$ = void 0 === $documentFragment$$4_index$$ ? 0 : $documentFragment$$4_index$$;
  $reference$$3_referenceDom$$ = (new JSDom$$module$Dom$JSDom($reference$$3_referenceDom$$)).exportElement($documentFragment$$4_index$$);
  $documentFragment$$4_index$$ = this.createDocumentFragment();
  DOMTree$$module$Dom$DOMTree$DOMTree.InsertNodeAfter($reference$$3_referenceDom$$, $documentFragment$$4_index$$);
  return this;
};
...
JSDom$$module$Dom$JSDom.prototype.onParents = function $JSDom$$module$Dom$JSDom$$onParents$($callbackFunction$$) {
  this.each(function($element$$, $index$$85_parent$$) {
    $index$$85_parent$$ = DOMTree$$module$Dom$DOMTree$DOMTree.GetParent($element$$);
    new JSDom$$module$Dom$JSDom($index$$85_parent$$, $callbackFunction$$, [$index$$85_parent$$, $element$$]);
  });
  return this;
};
...
JSDom$$module$Dom$JSDom.prototype.onChildren = function $JSDom$$module$Dom$JSDom$$onChildren$($callbackFunction$$, $dataArray$$) {
  this.each(function($children$$1_element$$, $index$$) {
    $children$$1_element$$ = DOMTree$$module$Dom$DOMTree$DOMTree.GetChildren($children$$1_element$$);
    new JSDom$$module$Dom$JSDom($children$$1_element$$, $callbackFunction$$, $dataArray$$);
  });
  return this;
};
...
JSDom$$module$Dom$JSDom.prototype.exportText = function $JSDom$$module$Dom$JSDom$$exportText$($element$$63_index$$) {
  $element$$63_index$$ = this.exportElement(void 0 === $element$$63_index$$ ? 0 : $element$$63_index$$);
  return DOMProperties$$module$Dom$DOMProperties$DOMProperties.GetProperty($element$$63_index$$, "innerText");
};
JSDom$$module$Dom$JSDom.prototype.find = function $JSDom$$module$Dom$JSDom$$find$($cssSelector$$) {
  var $found$$ = [];
  $cssSelector$$ && this.each(function($children$$3_element$$, $index$$) {
    $children$$3_element$$ = $children$$3_element$$.querySelectorAll($cssSelector$$);
    Arrays$$module$Algorithms$Arrays$Arrays.WidePush($found$$, (new JSDom$$module$Dom$JSDom($children$$3_element$$))._element);
  });
...
JSDom$$module$Dom$JSDom.prototype.getProp = function $JSDom$$module$Dom$JSDom$$getProp$($propertyName$$, $callbackFunction$$) {
  this.each(function($element$$, $index$$94_property$$) {
    $index$$94_property$$ = DOMProperties$$module$Dom$DOMProperties$DOMProperties.GetProperty($element$$, $propertyName$$);
    new JSDom$$module$Dom$JSDom($element$$, $callbackFunction$$, [$index$$94_property$$]);
  });
  return this;
};
JSDom$$module$Dom$JSDom.prototype.exportProp = function $JSDom$$module$Dom$JSDom$$exportProp$($propertyName$$, $element$$70_index$$) {
  $element$$70_index$$ = this.exportElement(void 0 === $element$$70_index$$ ? 0 : $element$$70_index$$);
  return DOMProperties$$module$Dom$DOMProperties$DOMProperties.GetProperty($element$$70_index$$, $propertyName$$);
};
...
JSDom$$module$Dom$JSDom.prototype.getProps = function $JSDom$$module$Dom$JSDom$$getProps$($propertyObject$$, $callbackFunction$$) {
  ...
  this.each(function($element$$, $index$$97_properties$$) {
    $index$$97_properties$$ = $index$$97_properties$$ ? {} : $propertyObject$$;
    for (var $i$$ = 0;$i$$ < $li$$;++$i$$) {
      var $key$$ = $propertyKeys$$[$i$$];
      $index$$97_properties$$[$key$$] = DOMProperties$$module$Dom$DOMProperties$DOMProperties.GetProperty($element$$, $key$$);
    }
...
JSDom$$module$Dom$JSDom.prototype.setProps = function $JSDom$$module$Dom$JSDom$$setProps$($propertyObject$$, $element$$73_index$$) {
  $element$$73_index$$ = this.exportElement(void 0 === $element$$73_index$$ ? 0 : $element$$73_index$$);
  DOMProperties$$module$Dom$DOMProperties$DOMProperties.SetProperties($element$$73_index$$, $propertyObject$$);
  return this;
};
...
JSDom$$module$Dom$JSDom.prototype.getValue = function $JSDom$$module$Dom$JSDom$$getValue$($callbackFunction$$) {
  this.each(function($element$$, $index$$101_value$$) {
    $index$$101_value$$ = DOMValue$$module$Dom$DOMValue$DOMValue.GetValue($element$$);
    new JSDom$$module$Dom$JSDom($element$$, $callbackFunction$$, [$index$$101_value$$]);
  });
  return this;
};
JSDom$$module$Dom$JSDom.prototype.exportValue = function $JSDom$$module$Dom$JSDom$$exportValue$($element$$76_index$$) {
  $element$$76_index$$ = this.exportElement(void 0 === $element$$76_index$$ ? 0 : $element$$76_index$$);
  return DOMValue$$module$Dom$DOMValue$DOMValue.GetValue($element$$76_index$$);
};
...
$jscomp.global.Object.defineProperties(JSDom$$module$Dom$JSDom.prototype, {count:{configurable:!0, enumerable:!0, get:function() {
  return this._element ? this._element.length : 0;
}}});
$jscomp.global.Object.defineProperties(JSDom$$module$Dom$JSDom, {doc:{configurable:!0, enumerable:!0, get:function() {
...
var module$Dom$TestJSDom = {}, TestJSDom$$module$Dom$TestJSDom = function $TestJSDom$$module$Dom$TestJSDom$($jspyder$$) {
  ...
  new TestDOMEvent$$module$Dom$DOMEvent$TestDOMEvent;
  ...
  new TestDOMEventInterface$$module$Dom$DOMEvent$TestDOMEventInterface($jspyder$$);
  new TestDOMPositionInterface$$module$Dom$DOMPosition$TestDOMPositionInterface($jspyder$$);
  new TestDOMTreeInterface$$module$Dom$DOMTree$TestDOMTreeInterface($jspyder$$);
};
...
JSLibrary$$module$Library$JSLibrary.prototype.Execute = function $JSLibrary$$module$Library$JSLibrary$$Execute$($functionName_lookupFunction$$, $argumentArray$$, $callbackFunction$$, $callbackArguments$$) {
  ...
  $argumentArray$$ = Functions$$module$Algorithms$Functions$Functions.Use(this._context, $functionName_lookupFunction$$, $argumentArray$$);
  Functions$$module$Algorithms$Functions$Functions.Use(this._context, $callbackFunction$$, [].concat([$argumentArray$$], $jscomp.arrayFromIterable($callbackArguments$$)));
...
$jscomp.global.Object.defineProperties(JSEnvironment$$module$Environment$JSEnvironment, {version:{configurable:!0, enumerable:!0, get:function() {
...
$jscomp.global.Object.defineProperties(JSCore$$module$JSCore.prototype, {alg:{configurable:!0, enumerable:!0, get:function() {
...
$jscomp.global.Object.defineProperties(JSCore$$module$JSCore, {DOM:{configurable:!0, enumerable:!0, get:function() {
